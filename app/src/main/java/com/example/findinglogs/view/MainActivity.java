...
public class MainActivity extends AppCompatActivity {
    ...
    private MainViewModel mainViewModel; // Já declarada, perfeito
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fetchButton.setOnClickListener(v -> { // Adicione o '{' aqui
            mainViewModel.fetchAllForecasts();
            Toast.makeText(MainActivity.this, "Atualizando dados...",
